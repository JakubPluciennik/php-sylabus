    ...
    <script>
        $(document).ready(function() {
            $('#print_form').submit(function() {
                // send post form with page contents
                $("#main_body").val($("#printable").html());
            });
        });
    </script>
</head>
...
<body>
    ...
    <form id="print_form" method="POST" action="class/download.php">
        <input type="hidden" name="main_body" id="main_body" value="">
        <input id="print" class="button button-primary" type="submit" name="submit" value="Zapisz Dokument">
    </form>
