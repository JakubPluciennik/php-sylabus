        ...
        <div id="pt1" class="table-div">
            <table autosize="1">
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo htmlspecialchars($_POST["course-title-eng"]) ?? ''; ?></td>
                </tr>
                <tr>
                    <td class="left-column">Zajęcia dla kierunku studiów/
                        Degree program name: </td>
                    <td colspan="3"><?php echo htmlspecialchars($_POST["degree"]) ?? ''; ?></td>
                </tr>
            </table>
        </div>
            ...
            <table autosize="1">
                <tr>
                    <td class="border-nr left-column" colspan="2">Język kursu/
                        Course language:</td>
                    <td class="border-nl" colspan="3"><?php echo htmlspecialchars($_POST["course-lang"] ) ?? ''; ?></td>
                    <td class="border-nr" colspan="2">Poziom studiów/
                        Study level:</td>
                    <td class="border-nl"><?php echo htmlspecialchars($_POST["study-lvl"]) ?? ''; ?></td>
                </tr>
                <tr>
                    ...
                    <td class="border-nr" colspan="2" rowspan="2">Semestr/
                        Semester: <?php echo isset($_POST["semester-value"]) ? htmlspecialchars($_POST["semester-value"]) : ''; ?></td>
                ...
                <tr>
                    <td class="border-a" colspan="5" class="align-right">Rok akademicki/
                        Academic year:</td>
                    <td class="border-ac" id="year"><?php echo htmlspecialchars($_POST["a-year"]) ?? ''; ?></td>
                    <td class="border-a" class="align-right">Numer katalogowy/
                        Catalogue number:</td>
                    <td class="border-ac"><?php echo htmlspecialchars($_POST["catalogue-num"]) ?? ''; ?></td>
                </tr>
            </table>
        </div>
        <div id="pt3" class="table-div">
            <table autosize="1">
                <tr>
                    ...
                    <td colspan="3"><?php echo htmlspecialchars($_POST["coordinator"]) ?? ''; ?></td>
                </tr>
                <tr>
                    <td colspan="2" class="left-column">Prowadzący zajęcia/
                        Teachers responsible for the course:</td>
                    <td colspan="3"><?php echo htmlspecialchars($_POST["responsible-teachers"]) ?? ''; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" class="left-column">Metody dydaktyczne/
                        Teaching methods:</td>
                    <td colspan="3"><?php echo htmlspecialchars($_POST["teaching-methods"]) ?? ''; ?></td>
                </tr>
                <tr>
                    <td colspan="2" class="left-column">Wymagania formalne i założenia wstępne/
                        Formal requirements and prerequisites</td>
                    <td colspan="3"><?php echo htmlspecialchars($_POST["formal-requirements"]) ?? ''; ?></td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        $w_relation = htmlspecialchars($w_row[0]['relation']) ?: '';
                    ...
                    for ($i = 1; $i < $w_count; $i++) {
                        ...
                        $w_relation = htmlspecialchars($w_row[$i]['relation']) ?: '';
                    ...
                    <tr>
                        ...
                        $u_relation = htmlspecialchars($u_row[0]['relation']) ?: '';
                    ...
                    for ($i = 1; $i < $u_count; $i++) {
                        ...
                        $u_relation = htmlspecialchars($u_row[$i]['relation']) ?: '';
                    ...
                    <tr>
                        ...
                        $k_relation = htmlspecialchars($k_row[0]['relation']) ?: '';
                    ...
                    for ($i = 1; $i < $k_count; $i++) {
                        ...
                        $k_relation = htmlspecialchars($k_row[$i]['relation']) ?: '';
                ...
                <tr>
                    <td colspan="2" class="left-column">Miejsce realizacji zajęć/
                        Teaching place:</td>
                    <td colspan="3"><?php echo htmlspecialchars($_POST["teaching-place"]) ?? ''; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" class="left-column">UWAGI/
                        ANNOTATIONS </td>
                    <td colspan="3"><?php echo htmlspecialchars($_POST["annotations"]) ?? ''; ?></td>
                </tr>
            </table>
        ...
        <div id="pt4" class="table-div">
            ...
            <table autosize="1">
                ...
                <tr>
                    ...
                    <td class="right font-size-xl bold"><?php echo htmlspecialchars($_POST["ects-val2"]) ?? ''; ?> ECTS</td>
                </tr>
            </table>
        </div>
    </main>
